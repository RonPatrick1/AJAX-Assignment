...
echo '<img id="firstColor" src="leftArrow';
if ($cColor == "Blue") {
    $cColor = "";
} else {
    $cColor = "-" . $cColor;
    ...
    <tr>
        ...
        <td align="center">
            <form id="form_submit" action="calendar.php" method="get">
                ...
                ?>
                <input id="defaultTitle" type="text" name="cal_title" value="">
        </td>
    </tr>
    <tr>
...
<div id="openModal" class="modalDialog">
    <div>
        ...
        <form id="form_submit2" action="enterEvent.php" method="post">
            ...
            <br>
            Description:<br>
            <textarea id="eventDescription" name="eventDescription" rows="4" cols="45" form="form_submit2"
                      value=""></textarea>
            <br>
